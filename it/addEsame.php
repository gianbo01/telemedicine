                ...
                if(val == 'wat'){
                    if (!waDisp){
                        ...
                        document.getElementById("wat").innerHTML = '<hr class="hr" />\
                            ...
                            <div class="mb-3 row">\
                                <label for="watval" class="col-sm-3 col-form-label">Widal Agglutination Test</label>\
                                <div class="col-sm-5">\
                                    <input type="number" class="form-control" id="watval" name="watval" required>\
                                </div>\
                                <div class="col-sm-1">\
                                </div>\
                                <div class="col-sm-1">\
                                    <input class="form-check-input" type="radio" name="watEsito" id="watEsito" value="Positivo" required>\
                                    <label class="form-check-label" for="watEsito">Positivo</label>\
                                </div>\
                                <div class="col-sm-1">\
                                    <input class="form-check-input" type="radio" name="watEsito" id="watEsito" value="Negativo" required>\
                                    <label class="form-check-label" for="watEsito">Negativo</label>\
                                </div>\
                            </div>';
                    }
                }
                    ...
                    if (!vlDisp){
                        ...
                        document.getElementById("vldl").innerHTML = '<hr class="hr" />\
                            ...
                            <div class="mb-3 row">\
                                ...
                                <div class="col-sm-8">\
                                    <input type="number" class="form-control" id="vldlval" name="vldlval" requireds>\
                                </div>\
                            </div>';
                    }
                }
