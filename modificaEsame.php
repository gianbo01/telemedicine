    ...
    <body>
        ...
        <?php
            ...
            if (isset($_POST['subES'])){
                ...
                $sql = "INSERT INTO `esame`(`id_paziente`, `data`, `tipo`, `note`, `ESR`, `redbc`, `whitebc`, `hemoglobin`, `hematocrit`, `platelets`, `CRP`, `colore`, `aspetto`, `ph`, `glucosio`, `proteine`, `emoglobina`, `corpiChetonici`, `bilirubina`, `urobilinogeno`, `leucociti`, `creatinina`, `PT`, `PTval`, `WAT`, `WATval`, `BATval`, `BAT`, `HBS`, `HBSval`, `HIV`, `HIVval`, `HCV`, `HCVval`, `FBS`, `BG`, `HPY`, `HPYval`, `CHO`, `TG`, `HDL`, `LDL`, `VLDL`, `ex`) 
                    VALUES ('$id','$data','$tipo','$noteV', '$esrval', '$redbloodcells', '$whitebloodcells', '$hemoglobin', '$hematocrit', '$platelets', '$crpval', '$colore', '$aspetto', '$ph', '$glucosio', '$proteine', '$emoglobina', '$corpichetonici', '$bilirubina', '$urobilinogeno', '$leucociti', '$creatinina', '$ptEsito', '$ptval', '$watEsito', '$watval', '$batval', '$batEsito', '$hbsEsito', '$hbsval', '$hivEsito', '$hivval', '$hcvEsito', '$hcvval', '$fbsval', '$bgval', '$hpyloriEsito', '$hpylorival', '$choval', '$tgval', '$hdlval', '$ldlval', '$vldlval', '$ex')";
            ...
            elseif (isset($_POST['subFile'])){
                ...
                $sql = "SELECT `id_paziente`, `data`, `tipo`, `num_esame`, `note`, `filePath`, `fileName`, `ESR`, `redbc`, `whitebc`, `hemoglobin`, `hematocrit`, `platelets`, `CRP`, `colore`, `aspetto`, `ph`, `glucosio`, `proteine`, `emoglobina`, `corpiChetonici`, `bilirubina`, `urobilinogeno`, `leucociti`, `creatinina`, `PT`, `PTval`, `WAT`, `WATval`, `BATval`, `BAT`, `HBS`, `HBSval`, `HIV`, `HIVval`, `HCV`, `HCVval`, `FBS`, `BG`, `HPY`, `HPYval`, `CHO`, `TG`, `HDL`, `LDL`, `VLDL`, `ex`
                    FROM `esame` 
        ...
        <div class="box">
			<form action='paziente.php?ID=<?php echo $id?>' method='post' onsubmit='return show_alert();'>
				<button type="button" class="btn btn-warning btn-lg col-5">Modifica</button>
				<button type="submit" class="btn btn-danger btn-lg col-5 float-end" value='<?php echo $num_esame ?>' name='eliminaE'>Elimina</button>
			</form>
		</div>
    </body>
</html>
