<html>
    ...
    <body>
        <?php
            ...
            $sql = "SELECT $L FROM `vochome`";          // prende il vocaboli dal db
        ...
        <nav class="navbar fixed-top navbar-expand-lg bg-primary">
            <div class="container-fluid">
                <a class="navbar-brand" href="home.php" style="color: white; font-size: 24px;"><b><?php echo $lang[0][$L]; ?></b></a>
                ...
                <div class="d-flex">
                    ...
                    <a href="logout.php">
                        <button type="button" class="btn btn-danger"><?php echo $lang[1][$L]; ?></button>
                    </a>
                </div>
            </div>
        </nav>
                ...
                <div class="col-sm-4">
                    <a href="addPaziente.php">
                        <button class="btn btn-primary w-100 p-3 fs-3" type="button" style="border-radius:25px">
                            <img src="rsc/add.png" width='60%' height='60%'><br><b><?php echo $lang[3][$L]; ?></b>
                        </button>
                    </a>
                </div>
                <div class="col-sm-4">
                    <a href="listaPazienti.php">
                        <button class="btn btn-primary w-100 p-3 fs-3" type="button" style="border-radius:25px">
                            <img src="rsc/list.png" width='60%' height='60%'><br><b><?php echo $lang[4][$L]; ?></b>
                        </button>
                    </a>
                </div>
                <div class="col-sm-4">
                    <a href="rubrica.php">
                        <button class="btn btn-primary w-100 p-3 fs-3" type="button" style="border-radius:25px">
                            <img src="rsc/contacts.png" width='60%' height='60%'><br><b><?php echo $lang[5][$L]; ?></b>
                        </button>
                    </a>
                </div>
            </div>
            ...
            if($session_role >= 7){
                echo "
                    <div class='mb-3 row' style='margin-left: 5%;'>
                        <div class='col-sm-4'>
                            <a href='admin.php'>
                                <button class='btn btn-primary w-100 p-3 fs-3' type='button' style='border-radius:25px'>⚙️ ".$lang[6][$L]."</button>
                            </a>
                        </div>
                    </div>
                ";
